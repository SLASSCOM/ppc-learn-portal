...
## Product and Platform building require new skills than just software development
...
- The obvious market competition factor
- The products are not made for a known user base but should cater diverse (and mostly unknown) user groups of future customers.
